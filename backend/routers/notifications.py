...
def mark_read(
    ...
    if not ids_in.ids:
        return JSONResponse(content={"updated": 0}, media_type="application/json; charset=utf-8")
    ...
    db.commit()
    return JSONResponse(content={"updated": updated}, media_type="application/json; charset=utf-8")
...
def delete_notification(
    ...
    db.delete(row)
    db.commit()
    return JSONResponse(content={"deleted": notification_id}, media_type="application/json; charset=utf-8")
